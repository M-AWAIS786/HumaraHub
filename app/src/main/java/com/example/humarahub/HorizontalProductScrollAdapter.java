            ...
            if(!title.equals("")) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent productDetailedIntent = new Intent(itemView.getContext(), ProductDetailsActivity.class);
                        productDetailedIntent.putExtra("PRODUCT_ID",productId);
                        itemView.getContext().startActivity(productDetailedIntent);
                    }
                });
            }
        }
